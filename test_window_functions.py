...
def make_matlab_winfunc_map():
    ...
    winfunc_map[ "blackman_periodic"        ] = lambda M : wf.blackman(M, wf.SFlag.PERIODIC)
    winfunc_map[ "blackman_symmetric"       ] = lambda M : wf.blackman(M, wf.SFlag.SYMMETRIC)
    winfunc_map[ "blackmanharris"           ] = lambda M : wf.blackmanharris(M)
    winfunc_map[ "blackmanharris_periodic"  ] = lambda M : wf.blackmanharris(M, wf.SFlag.PERIODIC)
    winfunc_map[ "blackmanharris_symmetric" ] = lambda M : wf.blackmanharris(M, wf.SFlag.SYMMETRIC)
    ...
    winfunc_map[ "flattopwin_periodic"      ] = lambda M : wf.flattopwin(M, wf.SFlag.PERIODIC)
    winfunc_map[ "flattopwin_symmetric"     ] = lambda M : wf.flattopwin(M, wf.SFlag.SYMMETRIC)
    ...
    winfunc_map[ "hamming_periodic"         ] = lambda M : wf.hamming(M, wf.SFlag.PERIODIC)
    winfunc_map[ "hamming_symmetric"        ] = lambda M : wf.hamming(M, wf.SFlag.SYMMETRIC)
    winfunc_map[ "hann"                     ] = lambda M : wf.hann(M)
    winfunc_map[ "hann_periodic"            ] = lambda M : wf.hann(M, wf.SFlag.PERIODIC)
    winfunc_map[ "hann_symmetric"           ] = lambda M : wf.hann(M, wf.SFlag.SYMMETRIC)
    ...
    winfunc_map[ "nuttallwin_periodic"      ] = lambda M : wf.nuttallwin(M, wf.SFlag.PERIODIC)
    winfunc_map[ "nuttallwin_symmetric"     ] = lambda M : wf.nuttallwin(M, wf.SFlag.SYMMETRIC)
...
def make_octave_winfunc_map():
    ...
    winfunc_map[ "flattopwin_periodic"      ] = lambda M : wf.flattopwin_octave(M, wf.SFlag.PERIODIC)
    winfunc_map[ "flattopwin_symmetric"     ] = lambda M : wf.flattopwin_octave(M, wf.SFlag.SYMMETRIC)
    ...
    winfunc_map[ "nuttallwin_periodic"      ] = lambda M : wf.nuttallwin_octave(M, wf.SFlag.PERIODIC)
    winfunc_map[ "nuttallwin_symmetric"     ] = lambda M : wf.nuttallwin_octave(M, wf.SFlag.SYMMETRIC)
    winfunc_map[ "parzenwin"                ] = lambda M : wf.parzenwin(M)
    winfunc_map[ "rectwin"                  ] = lambda M : wf.rectwin(M)
    winfunc_map[ "triang"                   ] = lambda M : wf.triang(M)
    winfunc_map[ "tukeywin"                 ] = lambda M : wf.tukeywin(M)
